...
> + Binaural hearing improves tolerance reverberationg enviroments (Harris and Reitz, 1985)

> + Binaural hearing abilities decrease with advancing age  (Ross, 2008; 2007, Vercammen et al. 2018). 

> - What about long ITDs? 

> + Longer ITD becomes relevant in reverberation and for integration of multiple sources

> + ITD in the envelope of common amplitude modulation may become the cue for broadband noise stimuli with long ITD (beyond the range for sound localization)
...
Input to one ear  -------------------> output at the auditory nerve
...
<!-- ![](./figures/itd_pathway.svg){width=80%} -->
...
<!-- - $\pi$-limit  -->
<!-- - straightness-weighting (weighted-image model) -->

<!-- ![](./figures/neural_density.png){width=80%} -->

<!-- (McAlpine et al. 2001; Stern and Shear 1996) -->
...
<!-- ![](./figures/neural_density_stern_shear_itd_0.5.png){width=80%} -->

<!-- ## -->

<!-- ![](./figures/neural_density_stern_shear_itd_1.0.png){width=80%} -->

<!-- ## -->

<!-- ![](./figures/neural_density_stern_shear_itd_1.5.png){width=80%} -->

<!-- ## -->

<!-- ![](./figures/neural_density_stern_shear_itd_2.0.png){width=80%} -->

<!-- ## -->

<!-- ![](./figures/neural_density_stern_shear_itd_2.5.png){width=80%} -->

<!-- ## -->

<!-- ![](./figures/neural_density_stern_shear_itd_3.0.png){width=80%} -->

<!-- ## -->

<!-- ![](./figures/neural_density_stern_shear_itd_3.5.png){width=80%} -->

<!-- ## -->

<!-- ![](./figures/neural_density_stern_shear_itd_4.0.png){width=80%} -->
...
- It sses light to measures the change in concentration of haemoglobin in blood: a proxy measure of total local neural activity (similar to fMRI).
...
- The brain needs oxigen to function. Blood carries oxygen to the brain as fuel for your neurons. 
...
- Fs: 16 384 kHz / 24 bits (Lowpass: 3 kHz)
...
- Simuli consisted of narrow-bandpass noise (300 - 700 Hz) at 75 dB SPL
